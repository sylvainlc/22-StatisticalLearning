...
$$
\widehat Y_\star - x_\star^\top\beta_\star = x_\star^\top (\widehat\beta_n - \beta_\star)\,,
$$
so that $\bE[\widehat Y_\star] =  x_\star^\top\beta_\star$ and
$$
\bE[(\widehat Y_\star - x_\star^\top\beta_\star)^2] = \mathbb{V}[\widehat Y_\star] = x_\star^\top \mathbb{V}[\widehat\beta_n]x_\star\,.
$$
On the other hand,
$$
