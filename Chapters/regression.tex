...
$$
\log p_\theta(Y_{1:n}) = \sum_{i=1}^{n}\log p_\theta(Y_{i}) =  \sum_{i=1}^{n}\left\{- \frac{1}{2}\log(2\pi \sigma_\star^2) - \frac{1}{2\sigma_\star^2}\left(Y_i - \param^\top X_i\right)^2\right\}\eqsp.
$$
